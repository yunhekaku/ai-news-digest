...
採点ルール:
- importance_score は「今日30秒で読むときの優先度」です。
- 平均は5〜6になるようにしてください。
- 同じ日のAIニュース一覧で上位5件に入るほど読むべき記事だけを8以上にしてください。
- 10は業界全体に大きな影響がある発表、規制、安全性、主要モデルの大幅更新だけにしてください。
- 8〜9は主要企業・主要モデル・開発者体験に明確な影響がある記事です。
- 6〜7は読む価値はあるが、影響範囲が限定的な記事です。
- 1〜5は導入事例、イベント告知、資金調達、まとめ記事、周辺的な話題です。
- 迷ったら低めにしてください。
"""
